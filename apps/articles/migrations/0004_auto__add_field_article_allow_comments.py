...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('articles_article', 'allow_comments', self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.allow_comments'
        db.delete_column('articles_article', 'allow_comments')
