...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.allow_comments'
        db.alter_column('articles_article', 'allow_comments', self.gf('django.db.models.fields.NullBooleanField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Article.allow_comments'
        db.alter_column('articles_article', 'allow_comments', self.gf('django.db.models.fields.BooleanField')())
