...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Forum.posts_index'
        db.add_column('forum_forum', 'posts_index', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Forum.posts_index'
        db.delete_column('forum_forum', 'posts_index')
