...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Thread.posts_index'
        db.add_column('forum_thread', 'posts_index', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Thread.posts_index'
        db.delete_column('forum_thread', 'posts_index')
