...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Forum.last_comment'
        db.add_column('forum_forum', 'last_comment', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['forum.ForumComment'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Forum.last_comment'
        db.delete_column('forum_forum', 'last_comment_id')
    ...
    models = {
        ...
        'forum.forum': {
            ...
            'last_comment': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['forum.ForumComment']", 'null': 'True', 'blank': 'True'}),
