...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Thread.last_post'
        db.add_column('forum_thread', 'last_post', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['forum.ForumPost'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Thread.last_post'
        db.delete_column('forum_thread', 'last_post_id')
