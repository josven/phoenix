...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Notification.announced'
        db.delete_column('notifications_notification', 'announced')

        # Adding field 'Notification.status'
        db.add_column('notifications_notification', 'status', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Notification.announced'
        db.add_column('notifications_notification', 'announced', self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True), keep_default=False)

        # Deleting field 'Notification.status'
        db.delete_column('notifications_notification', 'status')
